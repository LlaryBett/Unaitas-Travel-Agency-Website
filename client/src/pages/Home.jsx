...
const Home = () => {
                ...
                <div className="relative h-screen">
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-white text-center px-4">
                        ...
                        >
                           <a 
    href="/about" 
    className="max-w-[250px] px-6 py-2 sm:px-8 sm:py-3 text-base sm:text-lg bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg"
  >
    Learn More
  </a>
  ...
  <a 
    href="/book" 
    className="max-w-[250px] px-6 py-2 sm:px-8 sm:py-3 text-base sm:text-lg border-2 border-green-500 text-green-500 hover:bg-green-500 hover:text-white rounded-full shadow-lg transition-all"
  >
    Book Now
  </a>
                        </motion.div>
